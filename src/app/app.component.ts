...
//    this.weatherApiService.getCityWeather(this.city)
//      .subscribe((data) => {
//        this.cityTemp = data['main']['temp'];
//        this.cityConditions = data['weather'][0]['description'];
//        this.dataForCity = data['name'];
//      });
//  }
  
  getCitysInRadius(lat: number, lon: number, cnt: number) {
    let newDataSource: Array<WeatherData> = [];
